(function (b) {
  ...
  function H(a) {
    if (
      a &&
      a.allowPageScroll === undefined &&
      (a.swipe !== undefined || a.swipeStatus !== undefined)
    ) {
      a.allowPageScroll = V;
    }
  ...
  function N(bT, D) {
    ...
    function bv(ai, aj) {
      return Math.round(
        Math.sqrt(Math.pow(aj.x - ai.x, 2) + Math.pow(aj.y - ai.y, 2))
      );
    }
    function bJ(ak, am) {
      var an = ak.x - am.x;
    ...
    function C(aj, ai) {
      return (
        aj.x > ai.left && aj.x < ai.right && aj.y > ai.top && aj.y < ai.bottom
      );
    }
  }
});
  ...
  if (!aL.TweenLite) {
      ...
      aE = function (c, d, g, b) {
        ...
        (this.check = function (l) {
          for (var k, j, a, n, o = d.length, i = o; --o > -1; ) {
            (k = aR[d[o]] || new aE(d[o], [])).gsClass
              ? ((f[o] = k.gsClass), i--)
              : l && k.sc.push(this);
          }
          if (0 === i && g) {
            for (
              j = ("com.greensock." + c).split("."),
                a = j.pop(),
                ...
                b &&
                  ...
                  "function" == typeof define && define.amd
                    ? define(
                        (aA.GreenSockAMDPath ? aA.GreenSockAMDPath + "/" : "") +
                          c.split(".").pop(),
                        [],
                        function () {
                          return n;
      ...
      ac = (av.register = function (p, h, g, q) {
        for (
          var b,
            ...
            f = h.split(","),
            k = f.length,
            m = (g || "easeIn,easeOut,easeInOut").split(",");
          --k > -1;
    ...
    for (
      ...
      (aG = aB[aC] + ",Power" + aC),
        ...
        ac(
          new av(null, null, 2, aC),
          aG,
          "easeIn" + (0 === aC ? ",easeNone" : "")
        ),
    ...
    (aG = aS.prototype),
      (aG.addEventListener = function (k, g, d, m, a) {
        ...
        var b,
          ...
          j = 0;
        for (
          null == f && (this._listeners[k] = f = []), c = f.length;
          --c > -1;
        ...
        f.splice(j, 0, { c: g, s: d, up: m, pr: a }),
          this !== aT || aF || aT.wake();
      }),
        ...
        if (d) {
          for (f = d.length, a = this._eventTarget; --f > -1; ) {
            (c = d[f]),
              c &&
                (c.up
                  ? c.c.call(c.s || a, { type: b, target: a })
                  : c.c.call(c.s || a));
          }
        }
      });
    var aJ = aA.requestAnimationFrame,
      ...
      aw = Z();
    for (
      aB = ["ms", "moz", "webkit", "o"], aC = aB.length;
      --aC > -1 && !aJ;

    ) {
      (aJ = aA[aB[aC] + "RequestAnimationFrame"]),
        (ar =
          aA[aB[aC] + "CancelAnimationFrame"] ||
          aA[aB[aC] + "CancelRequestAnimationFrame"]);
    }
    ...
    ap(),
      ...
      (aG.isActive = function () {
        ...
        return (
          ...
          (!this._gc &&
            ...
            c.isActive() &&
            (b = c.rawTime()) >= a &&
            a + this.totalDuration() / this._timeScale > b)
        );
      }),
      ...
      (aG.eventCallback = function (b, f, a, c) {
        if ("on" === (b || "").substr(0, 2)) {
          ...
          null == f
            ...
            : ((d[b] = f),
              (d[b + "Params"] =
                aO(a) && -1 !== a.join("").indexOf("{self}")
                  ? this._swapSelfInParams(a)
                  : a),
              (d[b + "Scope"] = c)),
      ...
      (aG.totalTime = function (b, f, a) {
        ...
        if (this._timeline) {
          if (
            ...
            if (
              ...
              (this._startTime =
                ...
                (this._reversed ? c - b : b) / this._timeScale),
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime !== b || 0 === this._duration) &&
              (this.render(b, f, !1), au.length && af());
        }
        return this;
      }),
      (aG.progress = aG.totalProgress =
        function (a, b) {
          return arguments.length
      ...
      (aG.timeScale = function (b) {
        ...
        if (
          ((b = b || aU), this._timeline && this._timeline.smoothChildTiming)
        ) {
          ...
          !b &&
            ...
            !b &&
              ...
              this.render(
                d.smoothChildTiming
                  ? this._totalTime
                  : (a - this._startTime) / this._timeScale,
                !0,
                !0
              );
        }
        ...
        function (b, d) {
          ...
          if (
            ...
            b._paused &&
              this !== b._timeline &&
              (b._pauseTime =
                b._startTime + (this.rawTime() - b._startTime) / b._timeScale),
          ...
          return (
            a
              ? ((b._next = a._next), (a._next = b))
              : ((b._next = this._first), (this._first = b)),
              ...
              (d._reversed
                ? d.render(
                    (d._dirty ? d.totalDuration() : d._totalDuration) -
                      (b - d._startTime) * d._timeScale,
                    f,
                    a
                  )
                : d.render((b - d._startTime) * d._timeScale, f, a)),
            (d = c);
        }
      }),
      (aG.rawTime = function () {
          ...
          var g,
            ...
            j =
              ...
              (h.length &&
                h !== aA &&
                h[0] &&
                (h[0] === aA || (h[0].nodeType && h[0].style && !h.nodeType))),
            b = this.vars.overwrite;
          if (
            ((this._overwrite = b =
              null == b
                ? ab[aj.defaultOverwrite]
                : "number" == typeof b
                ? b >> 0
                : ab[b]),
            (j || h instanceof Array || (h.push && aO(h))) &&
              "number" != typeof h[0])
          ) {
            for (
              this._targets = c = az(h),
                this._propLookup = [],
                this._siblings = [],
                g = 0;
              c.length > g;
                ...
                k
                  ? "string" != typeof k
                    ? k.length &&
                      ...
                      k[0] &&
                      (k[0] === aA ||
                        (k[0].nodeType && k[0].style && !k.nodeType))
                      ? (c.splice(g--, 1),
                        (this._targets = c = c.concat(az(k))))
                      : ((this._siblings[g] = at(k, this, !1)),
                        1 === b &&
                          this._siblings[g].length > 1 &&
                          ak(k, this, null, 1, this._siblings[g]))
                    : ((k = c[g--] = aj.selector(k)),
                      "string" == typeof k && c.splice(g + 1, 1))
                  : c.splice(g--, 1);
            }
          } else {
            (this._propLookup = {}),
              ...
              1 === b &&
                ...
                ak(h, this, null, 1, this._siblings);
          }
          (this.vars.immediateRender ||
            (0 === d &&
              0 === this._delay &&
              this.vars.immediateRender !== !1)) &&
            ((this._time = -aU), this.render(-this._delay));
        },
        !0
      ),
      an = function (a) {
        return (
          ...
          a !== aA &&
          a[0] &&
          (a[0] === aA || (a[0].nodeType && a[0].style && !a.nodeType))
        );
      },
      ad = function (b, d) {
        var a,
    ...
    var at = function (b, f, a) {
        var c,
          ...
          g = b._gsTweenID;
        if (
          (am[g || (b._gsTweenID = g = "t" + aK++)] ||
            (am[g] = { target: b, tweens: [] }),
        ...
        for (g = b.length; --g > -1; ) {
          (d = b[g]) === w ||
            ...
            (d._timeline !== w._timeline
              ...
              : z >= d._startTime &&
                d._startTime + d.totalDuration() / d._timeScale > z &&
                (((x || !d._initted) && 2e-10 >= z - d._startTime) ||
                  (j[v++] = d)));
        }
        for (g = v; --g > -1; ) {
          if (
      ...
      ai = function (b, f, a) {
        for (
          var c = b._timeline, d = c._timeScale, g = b._startTime;
          c._timeline;
        ...
        return (
          ...
          g > f
            ? g - f
            : (a && g === f) || (!b._initted && 2 * aU > g - f)
            ? aU
            : (g += b.totalDuration() / b._timeScale / d) > f + aU
            ? 0
            : g - f - aU
        );
      };
    (aG._init = function () {
        ...
        ((this._ease = j =
          j
            ? j instanceof av
              ? j
              : "function" == typeof j
              ? new av(j, d.easeParams)
              : ax[j] || aj.defaultEase
            : aj.defaultEase),
        d.easeParams instanceof Array &&
          j.config &&
          (this._ease = j.config.apply(j, d.easeParams)),
      ...
      if (
        (k && aj._onPluginEvent("_onInitAllProps", this),
        m &&
          (this._firstPT ||
      ...
      (aG._initProps = function (k, g, q, b) {
        ...
        for (d in this.vars) {
          if (((p = this.vars[d]), al[d])) {
            p &&
              (p instanceof Array || (p.push && aO(p))) &&
              -1 !== p.join("").indexOf("{self}") &&
              (this.vars[d] = p = this._swapSelfInParams(p, this));
          } else {
            if (X[d] && (f = new X[d]())._onInitTween(k, this.vars[d], this)) {
              ...
              (this._firstPT =
                ...
                (j.s = j.f
                  ? k[
                      d.indexOf("set") ||
                      "function" != typeof k["get" + d.substr(3)]
                        ? d
                        : "get" + d.substr(3)
                    ]()
                  : parseFloat(k[d])),
                (j.c =
                  "string" == typeof p && "=" === p.charAt(1)
                    ? parseInt(p.charAt(0) + "1", 10) * Number(p.substr(2))
                    : Number(p) - j.s || 0);
            }
          }
      ...
      (aG.render = function (y, v, k) {
        ...
        if (y >= j) {
          ...
          if (1e-7 > y) {
            (this._totalTime = this._time = 0),
              ...
              (0 !== c || (0 === j && p > 0 && p !== aU)) &&
                ((b = "onReverseComplete"), (z = this._reversed)),
              0 > y &&
                ((this._active = !1),
                0 === j &&
                  (this._initted || !this.vars.lazy || k) &&
        ...
        if (this._time !== c || k) {
          if (!this._initted) {
            ...
            this._time && !z
              ? (this.ratio = this._ease.getRatio(this._time / j))
              : z &&
                this._ease._calcEnd &&
          ...
          this._onUpdate &&
            ...
            b &&
              ...
              !v &&
                this.vars[b] &&
                this.vars[b].apply(
                  this.vars[b + "Scope"] || this,
                  this.vars[b + "Params"] || Y
                ),
              0 === j &&
                this._rawPrevTime === aU &&
                w !== aU &&
                (this._rawPrevTime = 0));
        }
      }),
            ...
            for (w = this._targets.length; --w > -1; ) {
              if (k === this._targets[w]) {
                (c = this._propLookup[w] || {}),
                  ...
                  (b = this._overwrittenProps[w] =
                    v ? this._overwrittenProps[w] || {} : "all");
                break;
              }
            }
          } else {
          ...
          if (c) {
            ...
            for (d in j) {
              (m = c[d]) &&
                ...
                (m.pg && 0 !== m.t._overwriteProps.length) ||
                  (m._prev
                    ? (m._prev._next = m._next)
                    : m === this._firstPT && (this._firstPT = m._next),
      ...
      (aG._enabled = function (b, d) {
        ...
        return (
          aa.prototype._enabled.call(this, b, d),
          this._notifyPluginsOfEnabled && this._firstPT
            ? aj._onPluginEvent(b ? "_onEnable" : "_onDisable", this)
            : !1
        );
      }),
      ...
      (aj.fromTo = function (b, d, a, c) {
        return (
          (c.startAt = a),
          (c.immediateRender =
            0 != c.immediateRender && 0 != a.immediateRender),
          new aj(b, d, c)
        );
      }),
      ...
      (aj.killTweensOf = aj.killDelayedCallsTo =
        function (b, f, a) {
    ...
    if (
      ...
      (aG._addTween = function (d, h, c, f, g, k) {
        ...
        return null != f &&
          (b =
            "number" == typeof f || "=" !== f.charAt(1)
              ? Number(f) - c
              : parseInt(f.charAt(0) + "1", 10) * Number(f.substr(2)))
          ? ((this._firstPT = j =
              {
                _next: this._firstPT,
                t: d,
      ...
      (aG._roundProps = function (b, c) {
        for (var a = this._firstPT; a; ) {
          (b[this._propName] ||
            (null != a.n && b[a.n.split(this._propName + "_").join("")])) &&
            (a.r = c),
            (a = a._next);
        }
      }),
      ...
      for (aG in aR) {
        aR[aG].func ||
          aA.console.log(
            "GSAP encountered missing dependency: com.greensock." + aG
          );
      }
    }
    aF = !1;
    ...
    function (D, y, v) {
      var E = function (c) {
          ...
          for (f in h) {
            (a = h[f]),
              g(a) &&
                -1 !== a.join("").indexOf("{self}") &&
                (h[f] = this._swapSelfInParams(a));
          }
        ...
        d = function (c, l, a, f) {
          ...
          (l || !this._forcingPlayhead) &&
            (c._timeline.pause(c._startTime),
      ...
      return (
        ...
        (k.staggerTo = function (I, F, a, i, f, s, m, G) {
          ...
          for (
            "string" == typeof I && (I = v.selector(I) || I),
              I = I || [],
              A(I) && (I = x(I)),
              i = i || 0,
              0 > i && ((I = x(I)), I.reverse(), (i *= -1)),
              H = 0;
            I.length > H;
            H++
          ) {
        ...
        (k.staggerFromTo = function (G, u, m, H, c, l, F, f, p) {
          return (
            (H.startAt = m),
            (H.immediateRender =
              0 != H.immediateRender && 0 != m.immediateRender),
        ...
        (k.set = function (a, f, c) {
          return (
            ...
            null == f.immediateRender &&
              (f.immediateRender = c === this._time && !this._paused),
        ...
        (E.exportRoot = function (f, i) {
          ...
          for (
            ...
            (m = h._next),
              (i && h instanceof v && h.target === h.vars.onComplete) ||
                c.add(h, h._startTime - h._delay),
              (h = m);
          }
          return l.add(c, 0), c;
        }),
        (k.add = function (i, o, H, t) {
          var s, I, J, G, m, F;
          if (
            ("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, i)),
            !(i instanceof D))
          ) {
            if (i instanceof Array || (i && i.push && g(i))) {
              for (
                H = H || "normal", t = t || 0, s = o, I = i.length, J = 0;
                I > J;
                J++
              ) {
                g((G = i[J])) && (G = new E({ tweens: G })),
                  this.add(G, s),
                  "string" != typeof G &&
                    "function" != typeof G &&
                    ("sequence" === H
                      ? (s = G._startTime + G.totalDuration() / G._timeScale)
                      : "start" === H && (G._startTime -= G.delay())),
                  (s += t);
              }
          ...
          if (
            (y.prototype.add.call(this, i, o),
            (this._gc || this._time === this._duration) &&
              !this._paused &&
              this._duration < this.duration())
          ) {
            for (m = this, F = m.rawTime() > i._startTime; m._timeline; ) {
              F && m._timeline.smoothChildTiming
        ...
        (k._remove = function (c, a) {
          ...
          return (
            f
              ? this._time > f._startTime + f._totalDuration / f._timeScale &&
                ((this._time = this.duration()),
        ...
        (k._parseTimeOrLabel = function (h, a, c, f) {
          ...
          if ("string" == typeof a) {
            return this._parseTimeOrLabel(
              a,
              c && "number" == typeof h && null == this._labels[a]
                ? h - this.duration()
                : 0,
              c
            );
          ...
          if (
            ...
            if (((l = h.indexOf("=")), -1 === l)) {
              return null == this._labels[h]
                ? c
                  ? (this._labels[h] = this.duration() + a)
                  : a
                : this._labels[h] + a;
            }
            (a = parseInt(h.charAt(l - 1) + "1", 10) * Number(h.substr(l + 1))),
              (h =
                l > 1
                  ? this._parseTimeOrLabel(h.substr(0, l - 1), 0, c)
                  : this.duration());
          }
          return Number(h) + a;
        }),
          ...
          if (
            (N >= K
              ? ((this._totalTime = this._time = K),
                ...
                (this._rawPrevTime =
                  this._duration || !I || N || this._rawPrevTime === N ? N : b),
                (N = K + 0.0001))
              : 1e-7 > N
              ? ((this._totalTime = this._time = 0),
                (0 !== h ||
                ...
                0 > N
                  ? ((this._active = !1),
                    ...
                    (this._rawPrevTime = N))
                  : ((this._rawPrevTime =
                      this._duration || !I || N || this._rawPrevTime === N
                        ? N
                        : b),
                    (N = 0),
                    this._initted || (M = !0)))
                  ...
                  (O._reversed
                    ? O.render(
                        (O._dirty ? O.totalDuration() : O._totalDuration) -
                          (N - O._startTime) * O._timeScale,
                        I,
                        G
                      )
                    : O.render((N - O._startTime) * O._timeScale, I, G)),
                  (O = L);
              }
            } else {
              for (O = this._last; O && ((L = O._prev), !this._paused || J); ) {
                (O._active || (h >= O._startTime && !O._paused && !O._gc)) &&
                  (O._reversed
                    ? O.render(
                        (O._dirty ? O.totalDuration() : O._totalDuration) -
                          (N - O._startTime) * O._timeScale,
          ...
          for (var p = [], c = this._first, m = 0; c; ) {
            i > c._startTime ||
              (c instanceof v
                ...
                : (h !== !1 && (p[m++] = c),
                  f !== !1 &&
                    ((p = p.concat(c.getChildren(!0, l, h))), (m = p.length)))),
              (c = c._next);
          }
          return p;
        }),
        (k.getTweensOf = function (f, l) {
          var h,
            ...
            m = 0;
          for (
            p && this._enabled(!0, !0), h = v.getTweensOf(f), i = h.length;
            --i > -1;

          ) {
            (h[i].timeline === this || (l && this._contains(h[i]))) &&
              (c[m++] = h[i]);
          }
        ...
        (k._kill = function (c, l) {
          ...
          for (
            var a = l ? this.getTweensOf(l) : this.getChildren(!0, !0, !1),
              f = a.length,
              h = !1;
            --f > -1;
        ...
        (k.totalDuration = function (c) {
            ...
            if (this._dirty) {
              for (var l, a, f = 0, h = this._last, m = 999999999999; h; ) {
                (l = h._prev),
                  ...
                  h._startTime > m && this._sortChildren && !h._paused
                    ? this.add(h, h._startTime - h._delay)
                    : (m = h._startTime),
                  0 > h._startTime &&
                    !h._paused &&
                    ((f -= h._startTime),
                    this._timeline.smoothChildTiming &&
                      (this._startTime += h._startTime / this._timeScale),
          ...
          return (
            0 !== this.totalDuration() &&
              0 !== c &&
              this.timeScale(this._totalDuration / c),
            this
          );
        }),
    ...
    function (F) {
      var z,
        ...
        E = function (c, h, a, d) {
          var f = x(
            "easing." + c,
            { easeOut: new h(), easeIn: new a(), easeInOut: new d() },
            !0
          );
          return D(f, c), f;
        },
          ...
          G(
            ...
            function (a) {
              return (
                this._p1 *
                  Math.pow(2, -10 * a) *
                  Math.sin(((a - this._p3) * C) / this._p2) +
                1
              );
            },
            0.3
  ...
  _gsScope._gsDefine(
    ...
    function (au, aN) {
      ...
      var aJ,
        ...
        aW = (function () {
          var b,
            c = bl.indexOf("Android"),
            a = an.createElement("div");
          return (
            (aM =
              -1 !== bl.indexOf("Safari") &&
              -1 === bl.indexOf("Chrome") &&
              (-1 === c || Number(bl.substr(c + 8, 1)) > 3)),
            (aU = aM && 6 > Number(bl.substr(bl.indexOf("Version/") + 8, 1))),
            (az = -1 !== bl.indexOf("Firefox")),
            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(bl) ||
              /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(bl)) &&
              (aP = parseFloat(RegExp.$1)),
        ...
        bj = (aT.getStyle = function (b, f, a, d, c) {
          ...
          return aW || "opacity" !== f
            ? (!d && b.style[f]
                ...
                ? (g =
                    a[f] ||
                    a.getPropertyValue(f) ||
                    a.getPropertyValue(f.replace(a6, "-$1").toLowerCase()))
                : b.currentStyle && (g = b.currentStyle[f]),
              null == c ||
              (g && "none" !== g && "auto" !== g && "auto auto" !== g)
                ? g
                : c)
            : br(b);
        }),
        ...
        a5 = (bm.calculateOffset = function (b, f, a) {
          ...
          var d = "left" === f ? "Left" : "Top",
            c = bj(b, "margin" + d, a);
          return (
            b["offset" + d] - (bk(b, f, parseFloat(c), c.replace(ao, "")) || 0)
          );
        }),
        aV = function (b, f) {
          var a,
          ...
          return (
            null == k
              ...
              : ((m = 360),
                (d = k.split("_")),
                (j =
                  Number(d[0].replace(ar, "")) *
                    (-1 === k.indexOf("rad") ? 1 : bc) -
                  ("=" === k.charAt(1) ? 0 : h)),
                d.length &&
                  (b && (b[g] = h + j),
                  -1 !== k.indexOf("short") &&
      ...
      var a8 = function (w, p, j, b) {
        ...
        bC =
          ((bm._setPluginRatio = function (k) {
            ...
            if (
              (d.autoRotate && (d.autoRotate.rotation = j.rotation), 1 === k)
            ) {
              for (c = d.firstMPT; c; ) {
                if (((g = c.t), g.type)) {
                  if (1 === g.type) {
        ...
        al =
          ((bm._parseToProxy = function (D, x, q, b, E, k) {
            var A,
              j,
              m,
              v,
            ...
            for (
              q._transform = null,
                ...
                k &&
                  ((q._transform = z),
                  w && ((w._prev = null), w._prev && (w._prev._next = null)));
              b && b !== w;
        ...
        aa = (aT.parseComplex = function (E, V, N, H, F, K, X, J, L, D) {
          ...
          var U,
            ...
            m = aJ !== !1;
          for (
            (-1 !== H.indexOf(",") || -1 !== N.indexOf(",")) &&
              ((h = h.join(" ").replace(bn, ", ").split(" ")),
              (G = G.join(" ").replace(bn, ", ").split(" ")),
              (M = h.length)),
              M !== G.length && ((h = (K || "").split(" ")), (M = h.length)),
              X.plugin = L,
              X.setRatio = D,
              U = 0;
            M > U;
            ...
            if (((W = h[U]), (Q = G[U]), (z = parseFloat(W)), z || 0 === z)) {
              ...
              if (F && ("#" === W.charAt(0) || bh[W] || aS.test(W))) {
                (d = "," === Q.charAt(Q.length - 1) ? ")," : ")"),
                  ...
                  b && !aW && 0 === Q[3]
                    ? ((X["xs" + X.l] += X.l ? " transparent" : "transparent"),
                      (X.e = X.e.split(G[U]).join("transparent")))
                    : (aW || (b = !1),
                      X.appendXtra(
                        b ? "rgba(" : "rgb(",
                        W[0],
                        ...
                        .appendXtra("", W[1], Q[1] - W[1], ",", !0)
                        .appendXtra("", W[2], Q[2] - W[2], b ? "," : d, !0),
                      b &&
                        ((W = 4 > W.length ? 1 : W[3]),
                        X.appendXtra(
                          "",
      ...
      var aj = function (a, b) {
          (b = b || {}),
            ...
            (this.format =
              b.formatter ||
              a8(b.defaultValue, b.color, b.collapsible, b.multi)),
            ...
            bw(a, {
              parser: function (g, f, m, k, o, d, c) {
                var j = (_gsScope.GreenSockGlobals || _gsScope).com.greensock
                  .plugins[b];
                return j
                  ? (j._cssRegister(), aA[m].parse(g, f, m, k, o, d, c))
                  : (a0("Error: " + b + " js file not loaded."), o);
              },
            });
          }
        };
      (aF = aj.prototype),
        (aF.parseComplex = function (y, v, k, b, z, g) {
          ...
          if (
            (this.multi &&
              (bn.test(k) || bn.test(v)
                ? ((d = v.replace(bn, "|").split("|")),
                  (j = k.replace(bn, "|").split("|")))
                : c && ((d = [v]), (j = [k]))),
            j)
          ) {
            for (
              m = j.length > d.length ? j.length : d.length, w = 0;
              m > w;
              w++
            ) {
              (v = d[w] = d[w] || this.dflt),
        ...
        (aF.parse = function (d, g, c, f, h, b) {
          return this.parseComplex(
            d.style,
            this.format(bj(d, this.p, av, !1, this.dflt)),
            this.format(g),
            h,
            b
          );
      ...
      var am,
        ...
        ah = function (b, f, a) {
          var d,
            c = an.createElementNS("http://www.w3.org/2000/svg", b),
            g = /([a-z])([A-Z])/g;
          for (d in a) {
        ...
        ac = (function () {
          var b,
            d,
            a,
            c = aP || (/Android/i.test(bl) && !window.chrome);
          return (
            an.createElementNS &&
              !c &&
              ((b = ah("svg", ba)),
              (d = ah("rect", b, { width: 100, height: 50, x: 100 })),
        ...
        bp = function (b, d, a) {
          ...
          (d = ab(d).split(" ")),
            (a.xOrigin =
              (-1 !== d[0].indexOf("%")
                ? (parseFloat(d[0]) / 100) * c.width
                : parseFloat(d[0])) + c.x),
            (a.yOrigin =
              (-1 !== d[1].indexOf("%")
                ? (parseFloat(d[1]) / 100) * c.height
                : parseFloat(d[1])) + c.y);
        },
        bD = (bm.getTransform = function (b9, cn, cj, ca) {
          ...
          var ce,
            ...
            cl,
            b7,
            b3 = cj ? b9._gsTransform || new aR() : new aR(),
            b5 = 0 > b3.scaleX,
            bJ = 0.00002,
            b6 = 100000,
            cq = 179.99,
            bN = cq * bb,
            bK = a2
              ? parseFloat(bj(b9, ag, cn, !1, "0 0 0").split(" ")[2]) ||
                b3.zOrigin ||
                0
              : 0,
          ...
          if (
            (bH
              ? (ce = bj(b9, bB, cn, !0))
              : b9.currentStyle &&
                ((ce = b9.currentStyle.filter.match(a7)),
                (ce =
                  ce && 4 === ce.length
                    ? [
                        ce[0].substr(4),
                        Number(ce[2].substr(4)),
                        Number(ce[1].substr(4)),
                        ce[3].substr(4),
                        b3.x || 0,
                        b3.y || 0,
                      ].join(",")
              ...
              if (
                ...
                (b3.rotationX = bQ * bc),
                  ...
                  bQ &&
                    ...
                    (O = bR)),
                  be && M
                    ? (b3.rotation = b3.rotationX = 0)
                    : be && bX
                    ? (b3.rotation = b3.rotationY = 0)
                    : bX && M && (b3.rotationY = b3.rotationX = 0),
                  (b3.scaleX =
                    (0 | (Math.sqrt(ci * ci + O * O) * b6 + 0.5)) / b6),
                  (b3.scaleY =
                    (0 | (Math.sqrt(bM * bM + ch * ch) * b6 + 0.5)) / b6),
                  (b3.scaleZ =
                    (0 | (Math.sqrt(s * s + bY * bY) * b6 + 0.5)) / b6),
                  (b3.skewX = 0),
              ...
              if (
                !(
                  (a2 &&
                    ...
                    b3.x === cd[4] &&
                    b3.y === cd[5] &&
                    (b3.rotationX || b3.rotationY)) ||
                  (void 0 !== b3.x && "none" === bj(b9, "display", cn))
                )
              ) {
                var cr = cd.length >= 6,
                  b1 = cr ? cd[0] : 1,
                ...
                (b3.x = cd[4] || 0),
                  ...
                  (void 0 === b3.skewX ||
                    ...
                    cf > bJ ||
                    -bJ > cf ||
                    (cl > -cq && cq > cl && false | (cl * b6)) ||
                    (b7 > -cq && cq > b7 && false | (b7 * b6))) &&
                    ((b3.scaleX = cm),
                    (b3.scaleY = cc),
                    (b3.rotation = cs),
                    (b3.skewX = cp)),
                  a2 &&
                    ((b3.rotationX = b3.rotationY = b3.z = 0),
                    (b3.perspective = bL),
                    (b3.scaleZ = 1));
              }
            }
          ...
          if (F) {
            ...
            if (
              ...
              (0 === A || 1 === A) &&
                ...
                0 === L &&
                1 === z &&
                ((y && -1 === c.indexOf("Dx=0, Dy=0")) ||
                  (ap.test(O) && 100 !== parseFloat(RegExp.$1)) ||
              ...
              for (
                W = E.ieOffsetX || 0,
                  Q = E.ieOffsetY || 0,
                  E.ieOffsetX = Math.round(
                    (I - ((0 > G ? -G : G) * I + (0 > J ? -J : J) * M)) / 2 + x
                  ),
                  E.ieOffsetY = Math.round(
                    (M - ((0 > z ? -z : z) * M + (0 > L ? -L : L) * I)) / 2 + U
                  ),
                  ax = 0;
                4 > ax;
                ax++
                ...
                (j = bf[ax]),
                  ...
                  (K =
                    -1 !== q.indexOf("px")
                      ? parseFloat(q)
                      : bk(this.t, j, parseFloat(q), q.replace(ao, "")) || 0),
                  (k =
                    K !== E[j]
                      ? 2 > ax
                        ? -E.ieOffsetX
        ...
        bG = (bm.set3DTransformRatio = function (V) {
          ...
          (bR = 1),
            ...
            Z &&
              ...
              (U = bV),
              (bT = E)),
            1 !== be && ((ae *= be), (bJ *= be), (bR *= be), (bL *= be)),
            1 !== F && ((bO *= F), (bW *= F), (U *= F), (bT *= F)),
            1 !== bN && ((bS *= bN), (bK *= bN), (bP *= bN), (bU *= bN)),
            bQ &&
              ((bX -= bQ), (Y = ae * bX), (bM = bJ * bX), (bX = bR * bX + bQ)),
            q.svg &&
              ((Y += q.xOrigin - (q.xOrigin * bS + q.yOrigin * bO)),
              (bM += q.yOrigin - (q.xOrigin * bK + q.yOrigin * bW))),
            (Y = (p = (Y += W) - (Y |= 0))
              ? (0 | (p * Q + (0 > p ? -0.5 : 0.5))) / Q + Y
              : Y),
            (bM = (p = (bM += H) - (bM |= 0))
              ? (0 | (p * Q + (0 > p ? -0.5 : 0.5))) / Q + bM
              : bM),
            (bX = (p = (bX += G) - (bX |= 0))
              ? (0 | (p * Q + (0 > p ? -0.5 : 0.5))) / Q + bX
              : bX),
            (B[bH] =
              (q.xPercent || q.yPercent
                ? "translate(" + q.xPercent + "%," + q.yPercent + "%) matrix3d("
                : "matrix3d(") +
              [
                (0 | (bS * Q)) / Q,
                (0 | (bK * Q)) / Q,
            ...
            ? ((G = g.scaleX),
              ...
              g.rotation || g.skewX || g.svg
                ? ((z = g.rotation * bb),
                  ...
                  (x = Math.cos(w) * k),
                  g.svg &&
                    ((A += g.xOrigin - (g.xOrigin * C + g.yOrigin * v)),
                  ...
                  (E =
                    ...
                    ")"),
                  g.svg && am
                    ? D.setAttribute("transform", "matrix(" + E)
                    : (B[bH] =
                ...
                : (B[bH] =
                    ...
                    ")"),
              void 0)
            : ((this.setRatio = bG), bG.call(this, F), void 0);
        });
      bw(
        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
        {
          parser: function (s, I, E, w, B, A, D) {
            ...
            var F,
              ...
              K,
              J,
              C = (w._transform = bD(s, av, !0, D.parseTransform)),
              G = s.style,
              k = 0.000001,
              b = bA.length,
              j = D,
            ...
            if ("string" == typeof j.transform && bH) {
              ...
              if ("object" == typeof j) {
                ...
                "string" == typeof j.x &&
                  -1 !== j.x.indexOf("%") &&
                  ((F.x = 0), (F.xPercent = bF(j.x, C.xPercent))),
                  "string" == typeof j.y &&
                    -1 !== j.y.indexOf("%") &&
                    ((F.y = 0), (F.yPercent = bF(j.y, C.yPercent))),
                  (F.rotation = bx(
                    "rotation" in j
                      ? j.rotation
                      : "shortRotation" in j
                      ? j.shortRotation + "_short"
                      : "rotationZ" in j
                      ? j.rotationZ
                      : C.rotation,
                    C.rotation,
                  ...
                  (q = F.skewY - C.skewY) &&
                    ((F.skewX += q), (F.rotation += q));
              }
            }
            for (
              a2 && null != j.force3D && ((C.force3D = j.force3D), (K = !0)),
            ...
            return (
              ...
              K &&
                (w._transformType =
                  (C.svg && am) || (!L && 3 !== this._transformType) ? 2 : 3),
              B
            );
          },
          prefix: !0,
          ...
          parser: function (B, L, H, E, Q) {
            ...
            for (
              ...
              this.p.indexOf("border") && (O[G] = aZ(O[G])),
                ...
                -1 !== K.indexOf(" ") &&
                  ((A = K.split(" ")), (K = A[0]), (A = A[1])),
                (C = I = D[G]),
                (R = parseFloat(K)),
                (z = K.substr((R + "").length)),
                (q = "=" === C.charAt(1)),
                q
                  ? ((N = parseInt(C.charAt(0) + "1", 10)),
                    (C = C.substr(2)),
                    (N *= parseFloat(C)),
                    (J = C.substr((N + "").length - (0 > N ? 1 : 0)) || ""))
                  : ((N = parseFloat(C)), (J = C.substr((N + "").length))),
                "" === J && (J = aw[H] || z),
                J !== z &&
                  ((r = bk(B, "borderLeft", R, z)),
                  (j = bk(B, "borderTop", R, z)),
                  "%" === J
                    ? ((K = 100 * (r / M) + "%"), (A = 100 * (j / F) + "%"))
                    : "em" === J
                    ? ((s = bk(B, "borderLeft", 1, "em")),
                      (K = r / s + "em"),
                      (A = j / s + "em"))
                    : ((K = r + "px"), (A = j + "px")),
                  q &&
                    ((C = parseFloat(K) + N + J), (I = parseFloat(A) + N + J))),
          ...
          parser: function (E, z, v, b, k, B) {
            var j,
              ...
              q = this.format(
                (A
                  ? aP
                    ? A.getPropertyValue(C + "-x") +
                      " " +
                      A.getPropertyValue(C + "-y")
              ...
              x = this.format(z);
            if (
              (-1 !== q.indexOf("%")) != (-1 !== x.indexOf("%")) &&
              ((c = bj(E, "backgroundImage").replace(a4, "")),
              c && "none" !== c)
            ) {
              for (
                j = q.split(" "),
                ...
                (q = j[w]),
                  ...
                  D !== (-1 !== s[w].indexOf("%")) &&
                    ((y =
                      0 === w
                        ? E.offsetWidth - bg.width
                        : E.offsetHeight - bg.height),
                    (j[w] = D
                      ? (parseFloat(q) / 100) * y + "px"
                      : 100 * (parseFloat(q) / y) + "%"));
              }
              q = j.join(" ");
            }
        ...
        bw("backgroundSize", { defaultValue: "0 0", formatter: ab }),
        bw("perspective", { defaultValue: "0px", prefix: !0 }),
        bw("perspectiveOrigin", { defaultValue: "50% 50%", prefix: !0 }),
        bw("transformStyle", { prefix: !0 }),
        bw("backfaceVisibility", { prefix: !0 }),
        bw("userSelect", { prefix: !0 }),
        bw("margin", {
              ...
              9 > aP
                ? ((f = p.currentStyle),
                  ...
                  (c =
                    ...
                    f.clipLeft +
                    ")"),
                  (k = this.format(k).split(",").join(j)))
                : ((c = this.format(bj(p, this.p, av, !1, this.dflt))),
                  (k = this.format(k))),
        ...
        bw("border", {
          ...
          parser: function (d, g, c, f, h, b) {
            return this.parseComplex(
              d.style,
              this.format(
                bj(d, "borderTopWidth", av, !1, "0px") +
                  " " +
                  bj(d, "borderTopStyle", av, !1, "solid") +
                  " " +
                  bj(d, "borderTopColor", av, !1, "#000")
              ),
              this.format(g),
              h,
              b
      ...
      var by = function (b) {
        ...
        100 === c &&
          ...
          -1 === d.indexOf("radient(") &&
          -1 === d.indexOf("oader(")
            ? (a.removeAttribute("filter"), (f = !bj(this.data, "filter")))
            : ((a.filter = d.replace(aq, "")), (f = !0))),
          f ||
            (this.xn1 && (a.filter = d = d || "alpha(opacity=" + c + ")"),
            -1 === d.indexOf("pacity")
              ? (0 === c && this.xn1) ||
                (a.filter = d + " alpha(opacity=" + c + ")")
              : (a.filter = d.replace(ap, "opacity=" + c)));
      };
        ...
        parser: function (p, k, g, b, d, m) {
          ...
          return (
            "string" == typeof k &&
              "=" === k.charAt(1) &&
              (k =
                ("-" === k.charAt(0) ? -1 : 1) * parseFloat(k.substr(2)) + c),
            j &&
              1 === c &&
              "hidden" === bj(p, "visibility", av) &&
              0 !== k &&
              (c = 0),
            aW
              ? (d = new al(f, "opacity", c, k - c, d))
          ...
          b &&
            (a.removeProperty
              ? ("ms" === b.substr(0, 2) && (b = "M" + b.substr(1)),
                a.removeProperty(b.replace(a6, "-$1").toLowerCase()))
              : a.removeAttribute(b));
        },
        ai = function (b) {
      ...
      bw("className", {
        parser: function (A, s, b, j, x, i, k) {
          var m,
            ...
            v = A.style.cssText;
          if (
            ((x = j._classNamePT = new al(A, b, 0, 0, x, 2)),
            (x.setRatio = ai),
            (x.pr = -11),
            (aI = !0),
            (x.b = w),
          ...
          return (
            ...
            (x.e =
              "=" !== s.charAt(1)
                ? s
                : w.replace(RegExp("\\s*\\b" + s.substr(2) + "\\b"), "") +
                  ("+" === s.charAt(0) ? " " + s.substr(2) : "")),
            j._tween._duration &&
              (A.setAttribute("class", x.e),
              (m = bz(A, z, aV(A), k, g)),
      ...
      var bi = function (d) {
        if (
          ...
          if ("all" === this.e) {
            ...
            for (
              h = this.e.split(" ").join("").split(","), g = h.length;
              --g > -1;
                  ...
                  (j && aS.test(A))
                    ? (j ||
                        ...
                        (A =
                          ...
                          A.join(",") +
                          ")")),
                      (o = aa(z, y, b, A, !0, "transparent", o, 0, h)))
                    : !j || (-1 === A.indexOf(" ") && -1 === A.indexOf(","))
                    ? ((B = parseFloat(b)),
                      ...
                      (!B && 0 !== B) || (!r && 0 !== r)
                        ? void 0 !== z[y] &&
                          ...
                          ? ((o = new al(
                            ...
                            (o.xs0 =
                              "none" !== A ||
                              ("display" !== y && -1 === y.indexOf("Style"))
                                ? A
                                : b))
                          : a0("invalid " + y + " tween value: " + s[y])
                        : ((o = new al(
                            z,
                            y,
                            B,
                ...
                if (
                  ...
                  if (1 === c.type) {
                    if (((d = c.l), 2 === d)) {
                      ...
                      if (3 === d) {
                        c.t[c.p] =
                          c.xs0 + f + c.xs1 + c.xn1 + c.xs2 + c.xn2 + c.xs3;
                      } else {
                        if (4 === d) {
                          c.t[c.p] =
                            c.xs0 +
          ...
          return (
            b &&
              ...
              b._prev
                ...
                : this._firstPT === b && ((this._firstPT = b._next), (c = !0)),
              a
                ? (a._next = b)
                : c || null !== this._firstPT || (this._firstPT = b),
              (b._next = d),
              (b._prev = a)),
            b
          );
        ...
        (aF._kill = function (d) {
          ...
          return (
            d.className &&
              ...
              ((b = a.xfirst),
              b && b._prev
                ? this._linkCSSP(b._prev, a._next, b._prev._prev)
                : b === this._firstPT && (this._firstPT = a._next),
      ...
      var ad = function (d, h, c) {
        ...
        if (d.slice) {
          ...
          for (g = d.childNodes, f = g.length; --f > -1; ) {
            (j = g[f]),
              (b = j.type),
              j.style && (h.push(aV(j)), c && c.push(j)),
              (1 !== b && 9 !== b && 11 !== b) ||
                !j.childNodes.length ||
                ad(j, h, c);
          }
...
(function (w) {
  var J = w.GreenSockGlobals || w,
    ...
    G = function (c, g, a, d) {
      ...
      return (
        (a = a || M(c, null))
          ? ((c = a.getPropertyValue(g.replace(B, "-$1").toLowerCase())),
            (f = c || a.length ? c : a[g]))
          : c.currentStyle && ((a = c.currentStyle), (f = a[g])),
        d ? f : parseInt(f, 10) || 0
      );
    },
    E = function (a) {
    ...
    j = function (ay, aI, aG, az, aC) {
      ...
      for (
        ...
        if (((u = aa.charAt(aJ)), ")" === u && aa.substr(aJ, 20) === q)) {
          ...
          if (
            ...
            (")" !== aa.charAt(aJ + 1) || aa.substr(aJ + 1, 20) !== q) &&
              ((aH += au + n()), (at = !0));
          } else {
            aH += af && " " !== u ? ab() + u + "</div>" : u;
          }
        ...
        for (aJ = 0; aD > aJ; aJ++) {
          (aK = ax[aJ]),
            ...
            (aB || ag || (af && !ao)) &&
              ...
              ad &&
                ((ao !== aB && af) || (aL.push(aK), (aK._x -= ae)),
                aB && aJ && (ax[aJ - 1]._wordEnd = !0),
                "BR" === aK.nodeName &&
                  aK.nextSibling &&
                  "BR" === aK.nextSibling.nodeName &&
                  ad.push([])));
        }
      }
      for (aJ = 0; aD > aJ; aJ++) {
        (aK = ax[aJ]),
          ...
          "BR" !== aK.nodeName
            ? (ag &&
                ...
                ao ||
                  aB ||
                  ((aK._x += aK.parentNode._x), (aK._y += aK.parentNode._y)),
                (v.left = aK._x + "px"),
                (v.top = aK._y + "px"),
                (v.position = "absolute"),
                (v.display = "block"),
              ...
              ao
                ? aB && "" !== aK.innerHTML
                  ...
                  : af && ah.push(aK)
                : aB
                ? (ay.removeChild(aK), ax.splice(aJ--, 1), aD--)
                : !aB &&
                  af &&
                  ((aw = !ad && !ag && aK.nextSibling),
                  ay.appendChild(aK),
                  aw || ay.appendChild(C.createTextNode(" ")),
                  ah.push(aK)))
            : ad || ag
            ? (ay.removeChild(aK), ax.splice(aJ--, 1), aD--)
            : ao || ay.appendChild(aK);
      }
      if (ad) {
        for (
          ag &&
        ...
        for (aE = !ag || (!ao && !af), aJ = 0; ad.length > aJ; aJ++) {
          for (
            ...
            "BR" !== aL[av].nodeName &&
              ...
              aE &&
                (aK._wordEnd || ao) &&
                ac.appendChild(C.createTextNode(" ")),
              ag &&
                (0 === av &&
                  ((ac.style.top = aK._y + "px"),
          ...
          0 === aD && (ac.innerHTML = "&nbsp;"),
            ao ||
              af ||
              (ac.innerHTML = z(ac).split(String.fromCharCode(160)).join(" ")),
            ag && ((ac.style.width = ap), (ac.style.height = aK._h + "px")),
            ay.appendChild(ac);
        }
        ay.style.cssText = v;
      }
      ag &&
        (c > ay.clientHeight &&
          ((ay.style.height = c - r + "px"),
          c > ay.clientHeight && (ay.style.height = c + am + "px")),
        aA > ay.clientWidth &&
          ((ay.style.width = aA - aq + "px"),
    ...
    (K.selector =
      ...
      function (c) {
        ...
        return a
          ...
          : document.getElementById("#" === c.charAt(0) ? c.substr(1) : c);
      }),
    (K.version = "0.3.3");
})(_gsScope),
  (function (a) {
...
(function (a2, aK) {
  ...
  function aM(G, R) {
    ...
    if (G.data("aimg") != aK) {
      if (
        (G.data("aie8") == "enabled" && a6(8)) ||
        (G.data("amobile") == "enabled" && aq())
      ) {
        G.html(
    ...
    if (
      R.navigationStyle == "preview1" ||
      R.navigationStyle == "preview3" ||
      R.navigationStyle == "preview4"
    ) {
    ...
    R.desktop = !navigator.userAgent.match(
    ...
    if (
      R.forceFullWidth == "on" &&
      G.closest(".forcefullwidth_wrapper_tp_banner").length == 0
    ) {
      ...
      G.closest(".forcefullwidth_wrapper_tp_banner").append(
    ...
    try {
      if (
        R.hideThumbsUnderResolution > a2(window).width() &&
        R.hideThumbsUnderResolution != 0
      ) {
    ...
    if (!G.hasClass("revslider-initialised")) {
      ...
      G.find(".tp-caption").each(function (v) {
          ...
          if (
            ...
            a2("head")
              ...
              .each(function () {
                if (
                  a2(this).attr("src") ==
                  N + "://a.vimeocdn.com/js/froogaloop2.min.js"
                ) {
                  m = false;
                }
              });
        ...
        try {
          if (
            a2(this).data("videomp4") != aK ||
            a2(this).data("videowebm") != aK
          ) {
          }
        } catch (f) {}
      });
      ...
      if (R.shuffle == "on") {
        ...
        for (var h = 0; h < G.find(">ul:first-child >li").length; h++) {
          var l = Math.round(
            Math.random() * G.find(">ul:first-child >li").length
          );
          G.find(">ul:first-child >li:eq(" + l + ")").prependTo(
            G.find(">ul:first-child")
          );
        }
      ...
      if (R.shadow != 0) {
        G.parent().append(
          '<div class="tp-bannershadow tp-shadow' + R.shadow + '"></div>'
        );
        var V = 0;
      ...
      a2(window).on(
        ...
        function () {
          a2("body").data(
            "rs-fullScreenMode",
            !a2("body").data("rs-fullScreenMode")
          );
      ...
      a2(window).on(Q, function () {
        ...
        if (a2("body").find(G) != 0) {
          if (R.forceFullWidth == "on") {
            ...
            R.container
              .parent()
              .css({ left: 0 - b + "px", width: a2(window).width() });
          }
        }
  ...
  a2.fn.extend({
    revolution: function (b) {
      ...
      return this.each(function () {
        if (window.tplogs == true) {
          try {
            console.groupCollapsed(
              "Slider Revolution 4.6.3 Initialisation on " + a2(this).attr("id")
            );
    ...
    revscroll: function (a) {
      return this.each(function () {
        ...
        if (
          b != aK &&
          b.length > 0 &&
          a2("body").find("#" + b.attr("id")).length > 0
        ) {
          a2("body,html").animate(
            {
    ...
    revredraw: function (a) {
      return this.each(function () {
        ...
        if (
          d != aK &&
          d.length > 0 &&
          a2("body").find("#" + d.attr("id")).length > 0
        ) {
    ...
    revcurrentslide: function (d) {
      ...
      if (
        c != aK &&
        c.length > 0 &&
        a2("body").find("#" + c.attr("id")).length > 0
      ) {
  ...
  var aQ = function (d) {
    ...
    var c = window.location.href
      .slice(window.location.href.indexOf(d) + 1)
      .split("_");
  ...
  var aJ = function (g, b) {
    ...
    if (a2(window).width() < b.hideSliderAtLimit) {
      ...
      if (g.is(":hidden")) {
        if (
          q.data("olddisplay") != aK &&
          q.data("olddisplay") != "undefined" &&
          q.data("olddisplay") != "none"
        ) {
    ...
    a.find(".bullet").each(function (g) {
      ...
      f.click(function () {
        var i = false,
          h = f.index();
        if (
          d.navigationArrows == "withbullet" ||
          d.navigationArrows == "nexttobullets"
        ) {
          h = f.index() - 1;
        }
        if (h == d.act) {
      ...
      if (d.fullScreenOffsetContainer != aK) {
        ...
        try {
          if (
            ...
            d.fullScreenOffset != aK &&
            d.fullScreenOffset.length > 0
          ) {
            c =
              c - (a2(window).height() * parseInt(d.fullScreenOffset, 0)) / 100;
          } else {
  ...
  var aF = function (b, a) {
    ...
    b.find(">ul:first >li >img").each(function (q) {
      ...
      if (a.dottedOverlay != "none" && a.dottedOverlay != aK) {
        h.closest(".slotholder").append(
          '<div class="tp-dottedoverlay ' + a.dottedOverlay + '"></div>'
        );
      }
      var j = h.attr("src"),
        m = h.data("lazyload"),
  ...
  var am = function (d, g) {
    ...
    if (
      f.data("lazyload") != aK &&
      f.data("lazyload") != "undefined" &&
      f.data("lazydone") != 1
    ) {
      if (!a6(8)) {
        f.css({
          backgroundImage:
            'url("' + b.find(".defaultimg").data("lazyload") + '")',
        });
      } else {
  ...
  var ao = function (bQ, bK, bV, bJ, bO, bI) {
    ...
    var bf = 300;
    if (
      bV.data("masterspeed") != aK &&
      bV.data("masterspeed") > 99 &&
      bV.data("masterspeed") < bK.delay
    ) {
    ...
    bQ.parent()
      ...
      .each(function () {
        ...
        if (
          bK.navigationArrows == "withbullet" ||
          bK.navigationArrows == "nexttobullets"
        ) {
          d = c.index() - 1;
        }
        if (d == bK.next) {
    ...
    if (bY == 0) {
      ...
      bI.find(".slotslide").each(function (c) {
        ...
        bt.add(
          punchgs.TweenLite.from(d, bf / 600, {
            opacity: 0,
            top: 0 - bK.sloth,
            left: 0 - bK.slotw,
            rotation: bK.rotate,
    ...
    if (bY == 1) {
      ...
      bI.find(".slotslide").each(function (d) {
        ...
        bt.add(
          punchgs.TweenLite.from(g, c / 1000, {
            autoAlpha: 0,
            force3D: "auto",
            rotation: bK.rotate,
    ...
    if (bY == 2) {
      ...
      bO.find(".slotslide").each(function () {
        var c = a2(this);
        b1.add(
          punchgs.TweenLite.to(c, bf / 1000, {
            left: bK.slotw,
            force3D: "auto",
      ...
      bI.find(".slotslide").each(function () {
        var c = a2(this);
        b1.add(
          punchgs.TweenLite.from(c, bf / 1000, {
            left: 0 - bK.slotw,
            force3D: "auto",
            rotation: bK.rotate,
          }),
    ...
    if (bY == 6) {
      ...
      bO.find(".slotslide").each(function (d) {
        ...
        b1.add(
          punchgs.TweenLite.to(f, (bf + c) / 1000, {
            top: 0 + bK.height,
            opacity: 1,
            force3D: "auto",
            rotation: bK.rotate,
      ...
      bI.find(".slotslide").each(function (d) {
        ...
        b1.add(
          punchgs.TweenLite.from(f, (bf + c) / 1000, {
            top: 0 - bK.height,
            opacity: 1,
            force3D: "auto",
            rotation: bK.rotate,
    ...
    if (bY == 11 || bY == 26) {
      ...
      bI.find(".slotslide").each(function (c) {
        var d = a2(this);
        bt.add(
          punchgs.TweenLite.from(d, bf / 1000, {
            autoAlpha: 0,
            force3D: "auto",
            ease: punchgs.Power2.easeInOut,
          }),
    ...
    if (bY == 16) {
      var b1 = new punchgs.TimelineLite();
      bt.add(
        punchgs.TweenLite.set(bJ, { position: "absolute", "z-index": 20 }),
        0
      );
      bt.add(
        punchgs.TweenLite.set(bV, { position: "absolute", "z-index": 15 }),
        0
      );
      bJ.wrapInner(
      ...
      bJ.find(".tp-half-one .defaultimg").wrap(
      ...
      bJ.find(".tp-half-two .defaultimg").wrap(
        '<div class="tp-papercut" style="width:' +
          bu +
          "px;height:" +
          bp +
      ...
      bJ.find(".tp-half-two .tp-caption").wrapAll(
        '<div style="position:absolute;top:-50%;left:0px;"></div>'
      );
      bt.add(
        punchgs.TweenLite.set(bJ.find(".tp-half-two"), {
          width: bu,
          height: bp,
          overflow: "hidden",
          zIndex: 15,
      ...
      bt.add(
        punchgs.TweenLite.set(bJ.find(".tp-half-one"), {
          width: bu,
          height: bp / 2,
          overflow: "visible",
          zIndex: 10,
      ...
      bt.add(
        punchgs.TweenLite.set(bJ.find(".tp-half-one"), { overflow: "hidden" }),
        0
      );
      bt.add(
        punchgs.TweenLite.fromTo(
      ...
      b1.add(
        punchgs.TweenLite.set(bI.find(".defaultimg"), { autoAlpha: 1 }),
        0
      );
      if (bJ.html() != null) {
        bt.add(
      ...
      bI.find(".slotslide").each(function (c) {
        ...
        bt.add(
          punchgs.TweenLite.fromTo(
            ...
            { left: 0, delay: (c * 50) / 1000, ease: punchgs.Power2.easeInOut }
          ),
          0
        );
        bt.add(
  ...
  var aA = function (f, b, h, d, a, c, g) {
    ...
    if (
      b.parallax == "scroll" ||
      b.parallax == "scroll+mouse" ||
      b.parallax == "mouse+scroll"
    ) {
      a0(f, b);
    }
    g.clear();
  ...
  var aW = function (j, a, m, y) {
    ...
    q.each(function (bA) {
      ...
      if (bH == 0) {
        ...
        if (
          bF.hasClass("tp-videolayer") ||
          bF.find("iframe").length > 0 ||
          bF.find("video").length > 0
        ) {
          var bq = "iframe" + Math.round(Math.random() * 100000 + 1),
            ...
            bc = "http",
            bE =
              bF.data("videoloop") == "loop"
                ? "loop"
                : bF.data("videoloop") == "loopandnoslidestop"
                ? "loop"
                : "";
          ...
          bF.find("iframe").each(function () {
            ...
            if (
              bF.data("videoposter") != aK &&
              bF.data("videoposter").length > 2 &&
              bF.data("autoplay") != true &&
              !bv
            ) {
                ...
                setInterval(function () {
                  if (h.data("metaloaded") == 1 || d.duration != NaN) {
                    ...
                    if (!h.hasClass("HasListener")) {
                      ...
                      if (
                        bF.data("dottedoverlay") != "none" &&
                        bF.data("dottedoverlay") != aK
                      ) {
                        if (bF.find(".tp-dottedoverlay").length != 1) {
                          h.append(
                            '<div class="tp-dottedoverlay ' +
                              bF.data("dottedoverlay") +
                              '"></div>'
                          );
                        }
                      }
                      ...
                      if (
                        bF.data("forcecover") == 1 ||
                        bF.hasClass("fullscreenvideo")
                      ) {
        ...
        if (!bv) {
          ...
          if (
            bF.data("splitin") == "chars" ||
            bF.data("splitin") == "words" ||
            bF.data("splitin") == "lines" ||
            bF.data("splitout") == "chars" ||
            bF.data("splitout") == "words" ||
            bF.data("splitout") == "lines"
          ) {
            if (bF.find("a").length > 0) {
              bF.data(
                "mySplitText",
                new punchgs.SplitText(bF.find("a"), {
              ...
              if (bF.find(".tp-layer-inner-rotation").length > 0) {
                bF.data(
                  "mySplitText",
                  new punchgs.SplitText(bF.find(".tp-layer-inner-rotation"), {
                    type: "lines,words,chars",
                    charsClass: "tp-splitted",
                    wordsClass: "tp-splitted",
                    linesClass: "tp-splitted",
          ...
          if (
            ...
            ba.match("sfl") ||
            ba.match("sfb") ||
            ba.match("skewfromleftshort") ||
            ba.match("sfr") ||
            ba.match("skewfromrightshort")
          ) {
            M.opacity = 0;
          }
            ...
            if (ba.match("customin")) {
              ...
              if (ba.match("randomrotate") && a8 != bF) {
                for (var bA = 0; bA < a8.length; bA++) {
                  ...
                  B.append(
                    punchgs.TweenLite.fromTo(a8[bA], bf, X, bo),
                    "frame0"
                  );
                }
              } else {
  ...
  var ai = function (b, a) {
    b.find(".rs-pendulum").each(function () {
      ...
      if (j.data("timeline") == aK) {
        ...
        var f = j.data("startdeg") == aK ? -20 : j.data("startdeg"),
          ...
          c =
            j.data("easing") == aK ? punchgs.Power2.easeInOut : j.data("ease");
        f = f * a;
        g = g * a;
        j.data("timeline").append(
          new punchgs.TweenLite.fromTo(
            j,
            h,
            { force3D: "auto", rotation: f, transformOrigin: d },
            { rotation: g, ease: c }
          )
        );
        j.data("timeline").append(
          new punchgs.TweenLite.fromTo(
            j,
            h,
            { force3D: "auto", rotation: g, transformOrigin: d },
            {
              rotation: f,
              ease: c,
              onComplete: function () {
    ...
    b.find(".rs-rotate").each(function () {
      ...
      if (f.data("timeline") == aK) {
        ...
        c = c * a;
        d = d * a;
        f.data("timeline").append(
          new punchgs.TweenLite.fromTo(
            f,
            speed,
            { force3D: "auto", rotation: c, transformOrigin: origin },
            {
              rotation: d,
              ease: easing,
              onComplete: function () {
        ...
        var f = h.data("zoomstart") == aK ? 0 : h.data("zoomstart"),
          ...
          g =
            h.data("easing") == aK
              ? punchgs.Power2.easeInOut
              : h.data("easing");
        h.data("timeline").append(
          new punchgs.TweenLite.fromTo(
            h,
            d,
            { force3D: "auto", scale: f },
            { scale: c, ease: g }
          )
        );
        h.data("timeline").append(
      ...
      if (B != 0) {
        ...
        try {
          ...
          if (g > w) {
            ...
            if (i.css("opacity") != 0) {
              var k =
                i.data("endspeed") == aK ? i.data("speed") : i.data("endspeed");
              if (k > a) {
                a = k;
              }
              r.play("frame99");
  ...
  var ac = function (v, j, b, m, z, g) {
    ...
    if (
      ...
      w.match("stb") ||
      w.match("skewtoright") ||
      w.match("skewtorightshort") ||
      w.match("skewtoleft") ||
      w.match("skewtoleftshort") ||
      w.match("fadeout") ||
      w.match("randomrotateout")
    ) {
    ...
    if (c.slideamount > 1 && !(c.stopAfterLoops == 0 && c.stopAtSlide == 1)) {
      ...
      d.on("starttimer", function () {
        if (
          c.conthover != 1 &&
          c.videoplaying != true &&
          c.width > c.hideSliderAtLimit &&
          c.bannertimeronpause != true &&
          c.overnav != true
        ) {
          if (
            (c.stopLoop == "on" && c.next == c.lastslidetoshow - 1) ||
            c.noloopanymore == 1
          ) {
            c.noloopanymore = 1;
          } else {
