...
!(function (a) {
  ...
  function c(a) {
    var b = a.getBoundingClientRect(),
      ...
      f = d.pageXOffset;
    return (
      /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (f = 0),
      {
  ...
  function v(a, b, c) {
    return b
      ? void (c.xSteps[a] =
          n([c.xVal[a], c.xVal[a + 1]], b) / m(c.xPct[a], c.xPct[a + 1]))
      : !0;
  }
  function w(a, b, c, d) {
    (this.xPct = []),
  ...
  function Q(b, d) {
          ...
          if (
            ...
            for (h = t; u >= h; h += g) {
              for (
                ...
                (o = k + l * s), (f[o.toFixed(5)] = ["x", 0]);
              (p = d.indexOf(h) > -1 ? 1 : "steps" === c ? 2 : 0),
                !e && i && (p = 0),
                (h === u && j) || (f[m.toFixed(5)] = [h, p]),
                (k = m);
            }
        }),
        (M.direction = e),
    ...
    function s(a, b, c, e) {
      var f = function (b) {
          return I.hasAttribute("disabled")
            ...
            ? !1
            : ((b = L(b)),
              a === S.start && void 0 !== b.buttons && b.buttons > 1
                ? !1
    ...
    function t(a, b) {
      var c,
        ...
        h = e[0] === H[0] ? 0 : 1;
      if (
        ((c = K(g, b.positions, e.length > 1)),
        (f = y(e[0], c[h], 1 === e.length)),
        e.length > 1)
      ) {
    ...
    function w(a) {
      ...
      return (
        ...
        H[b].hasAttribute("disabled")
          ? !1
          : (y(H[b], e),
            q("slide", b),
            q("set", b),
            q("change", b),
            void (d.events.snap && v(a, { handles: [H[h]] })))
      );
    }
    function x(a) {
      var b, c;
      if (!a.fixed)
        for (b = 0; b < H.length; b += 1)
          s(S.start, H[b].children[0], v, { handles: [H[b]] });
    ...
    function y(a, b, c) {
      ...
      return (
        ...
        b === J[e]
          ? !1
          : ((a.style[d.style] = b + "%"),
            a.previousSibling || (k(a, T[17]), b > 50 && j(a, T[17])),
            (J[e] = b),
            (Q[e] = M.fromStepping(b)),
            q("update", e),
            !0)
      );
    }
      ...
      for (d.limit && (a += 1), c = 0; a > c; c += 1)
        (e = c % 2),
          ...
          null !== f &&
            ...
            (f === !1 ||
              isNaN(f) ||
              y(H[e], M.toStepping(f), c === 3 - d.dir) === !1) &&
              q("update", e));
    }
    function A(a) {
      var b,
    ...
    return (
      (G = P(d.dir, d.ort, I)),
      (H = O(d.handles, d.dir, G)),
      N(d.connect, I, H),
      x(d.events),
      d.pips && o(d.pips),
      { destroy: C, steps: D, on: E, off: F, get: B, set: A }
    );
  }
  function R(a, b) {
    if (!a.nodeName)
  ...
  (w.prototype.getMargin = function (a) {
    ...
    (w.prototype.toStepping = function (a) {
      return (
        (a = r(this.xVal, this.xPct, a)), this.direction && (a = 100 - a), a
      );
    }),
    ...
    (w.prototype.getStep = function (a) {
      return (
        ...
        (a = t(this.xPct, this.xSteps, this.snap, a)),
        this.direction && (a = 100 - a),
        a
      );
    }),
